      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-green-900 text-white rounded-2xl p-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/backtest/results" className="inline-block border border-white/50 hover:border-white text-white font-bold py-3 px-8 rounded-full text-sm transition-colors">
              バックテスト実績を確認する
            </Link>
          </div>
        </div>
