...
const KEYWORDS: Record<string, KeywordData> = {
  ...
  "oaks-2026-yoso-ai": {
    title: "オークス2026 予想 AI分析｜優駿牝馬5/24 本命・穴馬 | 競馬予想AI",
    h1: "オークス2026 AI予想｜優駿牝馬（5/24・東京芝2400m）",
    description: "オークス2026（5月24日・東京芝2400m）の本命・対抗・穴馬をAIが4軸分析。桜花賞上位馬の2400m適性・東京コース実績から買い目を提案。複勝回収率193%の実績AIが予測中。",
    features: [
      { icon: "🌸", title: "桜花賞組の2400m適性分析", text: "桜花賞1〜3着馬の末脚持続力・東京コース適性をAIが数値化。2400mへの距離延長で一変する馬を特定します" },
      { icon: "📊", title: "フローラS・スイートピーS組分析", text: "東京2000m経験済みのフローラS・スイートピーS組は2400mへの適性が高い。AIが直行ローテ馬との差を分析" },
      { icon: "🎯", title: "複勝回収率193%の実績AI", text: "当AIの複勝モードは重賞で回収率193%を記録。オークスは桜花賞上位3頭の複勝が基本戦略です" },
    ],
    faqs: [
      { q: "オークス2026の本命候補は？", a: "桜花賞上位馬（1〜3着）が有力です。AIは桜花賞の上がり3Fタイムと東京コース実績を重視します。出走馬確定後に詳細予想ページで確認できます。" },
      { q: "オークスで穴馬を狙うコツは？", a: "フローラS・スイートピーS勝ち馬（東京2000m経験済み）が穴候補です。桜花賞では距離が短すぎた長距離型の馬にも注意が必要です。AIが距離適性から穴候補を特定します。" },
      { q: "オークスは差し馬が有利？", a: "東京2400m外回りは直線518mと長く、差し・追い込みも決まります。ただし桜花賞好走の先行馬も十分有力。AIが展開と末脚の両面から分析します。" },
    ],
    lastUpdated: "2026-05-11",
  },
  "nihon-derby-2026-yoso-ai": {
    title: "日本ダービー2026 予想 AI分析｜5/31 本命・穴馬 | 競馬予想AI",
    h1: "日本ダービー2026 AI予想｜東京芝2400m（5/31）",
    description: "日本ダービー2026（5月31日・東京芝2400m）の本命・対抗・穴馬をAIが4軸分析。皐月賞上位馬の東京2400m適性・末脚持続力から買い目を提案。複勝回収率193%の実績AIが予測中。",
    features: [
      { icon: "🏆", title: "皐月賞組の東京適性分析", text: "皐月賞（中山2000m）から東京2400mへの適性変化をAIが分析。着順より上がり3Fタイムを重視します" },
      { icon: "📈", title: "距離延長で一変する馬の特定", text: "中山のコーナー加速力が求められる皐月賞と異なり、東京は末脚持続力が重要。AIが中山→東京で上昇する馬を特定" },
      { icon: "🎯", title: "複勝回収率193%の実績AI", text: "当AIの複勝モードは重賞で回収率193%を記録。ダービーは皐月賞1〜3着馬の複勝を軸に穴馬1頭を加えた戦略が基本" },
    ],
    faqs: [
      { q: "日本ダービー2026の本命候補は？", a: "皐月賞上位馬が中心ですが、東京コース実績のある馬が逆転することもあります。AIは皐月賞の着順より上がり3Fタイムと東京コース経験を重視します。" },
      { q: "ダービーで穴馬が出やすい理由は？", a: "皐月賞（中山）とダービー（東京）はコース形状が大きく異なるため、コース替わりで一変する馬が多く出ます。特に東京コース実績がある馬が穴を開けやすいです。" },
      { q: "ダービーの3連単は難しいですか？", a: "クラシックG1は実力差が出やすく3連単よりも3連複・ワイドの方が的中率が高い傾向があります。AIは複勝・ワイドを軸にした馬券構成を推奨します。" },
    ],
    lastUpdated: "2026-05-11",
  },
};
