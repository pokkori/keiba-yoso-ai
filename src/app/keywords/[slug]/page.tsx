...
export const KEYWORDS: Record<string, KeywordData> = {
  "keiba-yoso-ai-muryou": {
    title: "競馬 予想 AI 無料 高精度 | 競馬予想AI",
    h1: "競馬 予想 AI 無料 高精度",
    description: "無料で使える高精度の競馬AI予想。過去データ・血統・馬場状態を総合分析して的中率の高い予想を提供します。",
    features: [
      { icon: "🐎", title: "AI予想エンジン", text: "過去10年以上のレースデータをAIが学習。統計的アプローチで高精度な予想を実現" },
      { icon: "📊", title: "複合要因分析", text: "馬の実力・騎手・調教・馬場・展開を総合的に分析して予想スコアを算出" },
      { icon: "🆓", title: "無料で利用可能", text: "基本的なAI予想は無料で利用可能。プレミアムプランでさらに詳細な分析が可能" },
    ],
    faqs: [
      { q: "競馬AI予想の的中率は？", a: "AIの予想精度は過去データによる統計的分析に基づいており、単純な直感予想より高い一致率を示します。ただし競馬に絶対はなく、エンターテインメントとしてお楽しみください。" },
